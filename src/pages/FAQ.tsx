...
const questions = [
  ...
  {
    q: "Dimensão política",
    a: "A obra age como micropolítica do gesto e da ocupação sensível da cidade. Sua dimensão política é inseparável da prática, não declarativa. Criar sem esperar autorização institucional constitui, por si só, uma micropolítica do fazer.",
  },
  {
