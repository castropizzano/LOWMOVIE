          ...
          <AnimatedSection delay={0.1}>
            <div className="space-y-6 text-base md:text-lg leading-relaxed text-foreground/85">
              ...
              <p>
                ...
                papel central na construção da identidade cultural do skate. A <span className="text-primary font-medium">VideoParte</span> — formato
          ...
          <AnimatedSection delay={0.3} className="mt-16">
            ...
            <div className="space-y-6 text-foreground/85 leading-relaxed">
              ...
              <p>
                ...
                teórica, que emerge um conhecimento que não poderia ser produzido por nenhuma outra via. A pesquisa-criação
                não é uma versão menos rigorosa da pesquisa acadêmica: é uma forma distinta de rigor, que integra corpo,
                afeto e conceito na mesma operação investigativa.
              </p>
            </div>
          </AnimatedSection>
          ...
          <AnimatedSection delay={0.4} className="mt-16">
            ...
            <div className="space-y-4 text-foreground/85 leading-relaxed">
              ...
              <p>
                ...
                metodológica e epistemológica: amplia o repertório teórico-metodológico do campo do cinema e das
                artes do vídeo, oferecendo ferramentas conceituais derivadas da prática artística implicada e do
                fazer coletivo situado.
              </p>
            </div>
          </AnimatedSection>
        </div>
