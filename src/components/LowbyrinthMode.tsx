          ...
          <div className="relative w-full" style={{ minHeight: "100vh" }}>
            {lowbyrinthNodes.map((node, index) => (
              <motion.div
                ...
                onClick={() => setActiveNode(activeNode === node.path ? null : node.path)}
              >
                <div className={`
                  border rounded-lg p-4 min-w-[160px] max-w-[200px] transition-all duration-300
                      ...
                      >
                        <div className="pt-3 mt-3 border-t border-white/10 space-y-2">
                          ...
                          {node.derivas.map((d, i) => (
                            <button
                              key={i}
                              onClick={(e) => { e.stopPropagation(); handleNavigate(d.to); }}
                          ...
                          <button
                            onClick={(e) => { e.stopPropagation(); handleNavigate(node.path); }}
