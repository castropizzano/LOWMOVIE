...
const WelcomeOverlay = () => {
  ...
  return (
    <div
      className={`fixed inset-0 z-50 flex items-center justify-center backdrop-blur-sm className={`fixed inset-0 z-50 flex items-center justify-center backdrop-blur-sm bg-background/70 transition-opacity duration-400 ${closing ? "opacity-0" : "opacity-100"}`} transition-opacity duration-400 ${closing ? "opacity-0" : "opacity-100"}`}
    >
